...
public class EditProfileTest {
    ...
    public void editProfile() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText_email),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("naya7777@gmai"), closeSoftKeyboard());

        pressBack();

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText_email), withText("naya7777@gmai"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("naya7777@gmail.com"));
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.profileName), withText("po"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.rv),
                                        3),
        ...
        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.editProfileBTN),
                        childAtPosition(
                        ...
                        childAtPosition(
                                allOf(withId(R.id.profileLayout),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        appCompatEditText7.perform(scrollTo(), replaceText("ppt"), closeSoftKeyboard());
