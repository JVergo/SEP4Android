...
public class PlantInfoTest {
    ...
    @Test
    public void managePlantViewInfo() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText_email),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("naya7777@g"), closeSoftKeyboard());

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editText_email), withText("naya7777@g"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editText_email), withText("naya7777@g"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("naya7777@gmail.com"));
